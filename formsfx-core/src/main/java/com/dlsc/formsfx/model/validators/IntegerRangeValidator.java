...
public class IntegerRangeValidator extends CustomValidator<Number> {
   ...
   * @param errorMessage The error message that is returned if the validation
   *                     fails.
   *
   * @throws IllegalArgumentException Thrown if the maximum is not larger than or
  ...
  /**
   * Creates a IntegerRangeValidator with a given lower and upper bound, which are
   * equal.
   *
