...
public class SectionRenderer extends GroupRendererBase<Section> {
   ...
   *
   * @param section The section which gets rendered.
   */
  ...
  public void setupValueChangedListeners() {
    ...
    titledPane.expandedProperty()
        .addListener((observable, oldValue, newValue) -> element.collapsedProperty().setValue(!newValue));
    element.collapsedProperty()
        .addListener((observable, oldValue, newValue) -> titledPane.expandedProperty().setValue(!newValue));
  }
